function InitializeWorld(  )
	...
	CreateScriptComponent(GameLogic.playerInstance,
		PlayerMeta.init, PlayerMeta.update, PlayerMeta.destroy)
	...
	CreateScriptComponent(GameLogic.playerInstanceStone,
		PlayerMeta.init, PlayerMeta.update, PlayerMeta.destroy)
	...
	CreateScriptComponent(GameLogic.playerInstancePaper,
		PlayerMeta.init, PlayerMeta.update, PlayerMeta.destroy)
	...
	CreateScriptComponent(GameLogic.fanblade1, FanBladesMeta.init,
		FanBladesMeta.update, FanBladesMeta.destroy)
	GameLogic.fanblade1:initializeGameObjectFanBlade(fanblade.name,
		fanblade.position, fanblade.active, fanblade.rotationaxis, fanblade.baserotation)
	...
	CreateScriptComponent(GameLogic.fanblade2, FanBladesMeta.init,
		FanBladesMeta.update, FanBladesMeta.destroy)
	GameLogic.fanblade2:initializeGameObjectFanBlade(fanblade.name,
		fanblade.position, fanblade.active, fanblade.rotationaxis, fanblade.baserotation)
	...
	CreateScriptComponent(GameLogic.fanblade3, FanBladesMeta.init,
		FanBladesMeta.update, FanBladesMeta.destroy)
	GameLogic.fanblade3:initializeGameObjectFanBlade(fanblade.name,
		fanblade.position, fanblade.active, fanblade.rotationaxis, fanblade.baserotation)
	...
	CreateScriptComponent(GameLogic.fanblade4, FanBladesMeta.init,
		FanBladesMeta.update, FanBladesMeta.destroy)
	GameLogic.fanblade4:initializeGameObjectFanBlade(fanblade.name,
		fanblade.position, fanblade.active, fanblade.rotationaxis, fanblade.baserotation)
	...
	CreateScriptComponent(GameLogic.fanblade5, FanBladesMeta.init,
		FanBladesMeta.update, FanBladesMeta.destroy)
	GameLogic.fanblade5:initializeGameObjectFanBlade(fanblade.name,
		fanblade.position, fanblade.active, fanblade.rotationaxis, fanblade.baserotation)
	...
	CreateScriptComponent(GameLogic.fanblade6, FanBladesMeta.init,
		FanBladesMeta.update, FanBladesMeta.destroy)
	GameLogic.fanblade6:initializeGameObjectFanBlade(fanblade.name,
		fanblade.position, fanblade.active, fanblade.rotationaxis, fanblade.baserotation)
	...
	GameLogic.fan1:initializeGameObjectFan1(fan.name, fan.size, fan.position,
		fan.active, Config.fans.forces.stoneonly)
	...
	GameLogic.fan2:initializeGameObjectFan1(fan.name, fan.size, fan.position,
		fan.active, Config.fans.forces.paperonly)
	...
	GameLogic.fan3.blades = {GameLogic.fanblade3, GameLogic.fanblade4, GameLogic.fanblade5,
							 GameLogic.fanblade6}
	CreateScriptComponent(GameLogic.fan3, FanMeta.init, FanMeta.update, FanMeta.destroy)
	GameLogic.fan3:initializeGameObjectFan1(fan.name, fan.size, fan.position, fan.active,
		Config.fans.forces.woodonly)


	-- create transformators
	local transformator = Config.transformators.transformator1
	GameLogic.transformator1 = createPhantomCallbackTriggerBox(transformator.name,
		Config.transformators.transformatorsize, transformator.position)
	...
	GameLogic.transformator2 = createPhantomCallbackTriggerBox(transformator.name,
		Config.transformators.transformatorsize, transformator.position)
	...
	GameLogic.transformator3 = createPhantomCallbackTriggerBox(transformator.name,
		Config.transformators.transformatorsize, transformator.position)
	...
	GameLogic.transformator4 = createPhantomCallbackTriggerBox(transformator.name,
		Config.transformators.transformatorsize, transformator.position)
	...
	GameLogic.trigger1 = FanMeta:createPhantomCallbackTriggerBox(triggerC.name,
		Config.triggers.triggersize, triggerC.position)
	...
	local gotrigger = CreateEmptyGameObject(triggerC.name)
	GameLogic.trigger2 = FanMeta:createPhantomCallbackTriggerBox(triggerC.name,
		Config.triggers.triggersize, triggerC.position)
	...
	triggerEnd = FanMeta:createPhantomCallbackTriggerBox(triggerC.name,
		Config.triggers.triggersize, triggerC.position)
	...
	trigger = FanMeta:createPhantomCallbackTriggerBox("trigger for groundfall",
		Vec3(Config.world.worldSize/2.0,
			 Config.world.worldSize/2.0,
			 3.0),
		Vec3(0.0,0.0,-Config.world.worldSize/2.5))
