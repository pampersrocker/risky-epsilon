Config = {
	...
	fractures =
	{
		...
		fracture01 =
		{
			...
			model = "data/models/Sphere/Fracture001.thModel",
			dimension = Vec3(0.5,0.5,0.8),
			useShape = false,
		...
		fracture02 =
		{
			...
			model = "data/models/Sphere/Fracture002.thModel",
			dimension = Vec3(0.5,0.5,0.8),
			useShape = false,
			offset = Vec3(0.0,0.0,0.0),
			randomOffset = true,mass = 5,
		},
		fracture03 =
		{
			name = "fracture03",
			collFile = "data/collision/fracture_03.hkx",
			model = "data/models/Sphere/Fracture003.thModel",
			dimension = Vec3(0.5,0.5,0.8),
			useShape = false,
			offset = Vec3(0.0,0.0,0.0),
			randomOffset = true,
		...
		fracture04 =
		{
			...
			model = "data/models/Sphere/Fracture004.thModel",
			dimension = Vec3(0.5,0.5,0.8),
			useShape = false,
			offset = Vec3(0.0,0.0,0.0),
			randomOffset = true,
		...
		fracture05 =
		{
			...
			model = "data/models/Sphere/Fracture005.thModel",
			dimension = Vec3(0.5,0.5,0.8),
			useShape = false,
			offset = Vec3(0.0,0.0,0.0),
			randomOffset = true,
		...
		fracture06 =
		{
			...
			model = "data/models/Sphere/Fracture006.thModel",
			dimension = Vec3(0.5,0.5,0.8),
			useShape = false,
			offset = Vec3(0.0,0.0,0.0),
			randomOffset = true,
		...
		fracture07 =
		{
			...
			model = "data/models/Sphere/Fracture007.thModel",
			dimension = Vec3(0.5,0.5,0.8),
			useShape = false,
			offset = Vec3(0.0,0.0,0.0),
			randomOffset = true,
		...
		fracture08 =
		{
			...
			model = "data/models/Sphere/Fracture008.thModel",
			dimension = Vec3(0.5,0.5,0.8),
			useShape = false,
			offset = Vec3(0.0,0.0,0.0),
			randomOffset = true,
		...
		fracture09 =
		{
			...
			model = "data/models/Sphere/Fracture009.thModel",
			dimension = Vec3(0.5,0.5,0.8),
			useShape = false,
			offset = Vec3(0.0,0.0,0.0),
			randomOffset = true,
		...
		fracture10 =
		{
			...
			model = "data/models/Sphere/Fracture010.thModel",
			dimension = Vec3(0.5,0.5,0.8),
			useShape = false,
			offset = Vec3(0.0,0.0,0.0),
			randomOffset = true,
		...
		fracture11 =
		{
			...
			model = "data/models/Sphere/Fracture011.thModel",
			dimension = Vec3(0.5,0.5,0.8),
			useShape = false,
			offset = Vec3(0.0,0.0,0.0),
			randomOffset = true,
		...
		fracture13 =
		{
			...
			model = "data/models/Sphere/Fracture013.thModel",
			dimension = Vec3(0.5,0.5,0.8),
			useShape = false,
			offset = Vec3(0.0,0.0,0.0),
			randomOffset = true,
