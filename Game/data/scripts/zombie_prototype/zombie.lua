...
function hitZombieBodyPart(hitBody, damage)
	...
	local zombie = __zombies[bodyPartGO:getName()]
...
function __zombie__isBodyPart(self, bodyPart, names)
	...
	for _, v in ipairs(names) do
		result = result or bodyPart:getName() == self.bodyParts[v]:getName()
		print("comparing " .. bodyPart:getName() .. " with " .. self.bodyParts[v]:getName())
	end
...
function createZombie(guid)
	...
	zombie.rc:setPath("data/models/barbarian/barbarianAnimated.thModel")
